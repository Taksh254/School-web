...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (user && !loading) {
      ...
      if (redirectParam && redirectParam.startsWith("/")) {
        ...
        window.location.href = `/dashboard/${user.role === "admin" ? "admin" : "parent"}`
      }
    }
  }, [user, loading, router])
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-1/4 left-[5%] text-pistachio/10 text-2xl select-none"
      ...
      >
        <div className="bg-soft-white rounded-[32px] p-8 sm:p-10 shadow-card border border-white/50 paper-texture">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-olive text-[28px] sm:text-[32px] font-display font-bold leading-tight mb-1.5">
          ...
          <AnimatePresence mode="wait">
            {mode === "login" ? (
              ...
              >
                <div>
                  <label htmlFor="login-email" className="block text-sm font-medium text-olive mb-1.5 text-left font-body">
                    Email Address
                  </label>
                  <input
                    id="login-email"
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label htmlFor="login-password" className="block text-sm font-medium text-olive text-left font-body">
                      Password
                    </label>
                    <Link href="/forgot-password" className="text-xs text-pistachio hover:underline font-body font-medium">
                      Forgot Password?
                    </Link>
                  </div>
              ...
              >
                <div>
                  <label htmlFor="signup-name" className="block text-sm font-medium text-olive mb-1.5 text-left font-body">
                    Full Name
                  </label>
                  <input
                    id="signup-name"
                ...
                <div>
                  <label htmlFor="signup-email" className="block text-sm font-medium text-olive mb-1.5 text-left font-body">
                    Email Address
                  </label>
                  <input
                    id="signup-email"
                ...
                <div>
                  <label htmlFor="signup-password" className="block text-sm font-medium text-olive mb-1.5 text-left font-body">
                    Password
                  </label>
                  <div className="relative">
                    <input
