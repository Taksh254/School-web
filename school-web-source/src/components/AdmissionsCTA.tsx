  ...
  return (
    <section className="py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-soft-white rounded-3xl border border-beige/30 shadow-soft p-8 md:p-12 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-pistachio/10 via-cream/10 to-sage/10" />
