...
export default function HomeGallery() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-cream via-soft-white to-cream">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-24 pb-6 md:pb-8">
        <motion.div
      ...
      <div className="relative w-full h-[60vh] min-h-[400px] md:min-h-[500px] lg:h-[70vh]">
        <DomeGallery
          grayscale={false}
      ...
      <div className="relative z-10 flex justify-center pb-16 md:pb-20 -mt-2">
        <Link
          href="/gallery"
